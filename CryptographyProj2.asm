...
ExitInput 		                ;
	     ...
	     ADD R2, R2, #-16	        ; ^^
	     ADD R3, R1, 2    		; Makes R3 point to first char in input messge for encryption from the memory location in R1
	     ...
	     ADD R1, R6, R1  		; Adds R1 and R6 to check if D was first input
